...
> el puerto 8044 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                               STATUS                    PORTS
> proyecto_construccion_de_software3-api-facturas-1   Up 2 hours                0.0.0.0:8044->8044/tcp
> proyecto_construccion_de_software3-postgres-1       Up 2 hours (healthy)      0.0.0.0:15444->5432/tcp
> ```
>
...
```powershell
git clone https://github.com/ccastro2050/proyecto_construccion_de_software3.git
cd proyecto_construccion_de_software3
...
| Qué | Dónde |
|---|---|
| **API Facturas** — diagnóstico | http://localhost:8044/ |
| **Swagger** (documentación interactiva: ver y probar los endpoints) | http://localhost:8044/swagger |
| Listar productos | http://localhost:8044/api/producto |
| PostgreSQL (para SQLTools/pgAdmin, opcional) | `localhost:15444` · `postgres`/`Construccion123!` |
...
> ℹ️ Este proyecto usa los puertos 8044 y 15444: si alguno ya está ocupado
...
```
proyecto_construccion_de_software3/
...
│
├── api_facturas/                # LA API DE LA v1 — C#/ASP.NET Core (puerto 8044)
...
│   ├── appsettings.json         # Cadena de conexión (default localhost:15444)
