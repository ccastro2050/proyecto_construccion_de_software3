...
└── api_facturas/
    ...
    ├── Dockerfile                    # sdk:10.0 + dotnet watch (puerto 8044)
    ├── Modelos/
...
funcionando. En v1 eso son **dos servicios**: `postgres` (15444 al host,
se siembra solo) y `api-facturas` (8044, código montado +
