...
> [README](../README.md)). PostgreSQL queda publicado en `localhost:15444`.
...
| Port | `15444` | El puerto del host del compose (`15444:1433`) |
...
> El puerto es la clave: **15444, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 15444
...
>
> ```
> Error opening connection Failed to connect to localhost:15444
...
> (`http://localhost:8044/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost:15444) con test y guardarla |
